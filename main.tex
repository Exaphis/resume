...
\renewcommand\Huge{\@setfontsize\Huge{30pt}{18}}
\makeatother
...
B.S. in Mathematics Honors \hfill Dean's List + Semester Honors all semesters
...
\textbf{Tools/Frameworks:} Git, Django, React, Linux
...
Software Engineer Intern, Foundational Storage \hfill \textit{May 2022 -- Aug. 2022}

\resumeItemListStart
	\item Extended Two Sigma's S3 Web UI (TS3UI) to Google Cloud Storage buckets using Java and Python
	\item Spearheaded TS3UI redesign by creating mockups in Figma and implementing designs in React, releasing to over 400 monthly active users
	\item Led unification of bucket permission management using ACLs in on-prem and GCS buckets
	\item Discovered and patched cross site scripting vulnerabilities within three internal products
\resumeItemListEnd
