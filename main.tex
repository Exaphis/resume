...
\resumeItemListStart
	\item Extended Two Sigma's S3 web interface (TS3UI) to Google Cloud Storage buckets with Java and Python
	\item Mocked up and implemented redesign of TS3UI using Figma and React
